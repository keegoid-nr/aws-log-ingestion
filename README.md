...
{
  "context": {
    "function_name": "kmullaney-log-ingestion",
    "invoked_function_arn": "arn:aws:lambda:<your_aws_region>:<your_aws_account>:function:kmullaney-log-ingestion",
    "log_group_name": "/aws/lambda/kmullaney-log-ingestion",
